...
export declare abstract class DateAdapter<D> {
     ...
     */
    compareDate(first: D, second: D, unit?: string): number;
    /**
     ...
     */
    sameDate(first: D | null, second: D | null, unit?: string): boolean;
    /**
     ...
     *     otherwise `date`.
     */
    clampDate(date: D, min?: D | null, max?: D | null, unit?: string): D;
}
