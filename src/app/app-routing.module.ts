...
const routes: Routes = [
  ...
  { path: 'trainings', loadChildren: 'src/app/owner/owner.module#OwnerModule' },
  ...
  {
    path: 'traning-detail',
    loadChildren: 'src/app/owner/training-details/training-details.module#TrainingDetailsModule'
  },
