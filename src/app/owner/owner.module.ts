...
import { NewTrainingsModule } from 'src/app/owner/new-trainings/new-training.module';

@NgModule({
    declarations: [OwnerListComponent, Header_Component, SidenavList_Component, Layout_Component],
    imports: [
        CommonModule,
        OwnerRoutingModule,
        MaterialModule,
    ...
    exports: [Header_Component, SidenavList_Component, Layout_Component, OwnerListComponent],
